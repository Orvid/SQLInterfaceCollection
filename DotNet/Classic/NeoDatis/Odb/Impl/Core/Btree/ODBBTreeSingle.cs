namespace NeoDatis.Odb.Impl.Core.Btree
{
	...
	[System.Serializable]
	public class ODBBTreeSingle : NeoDatis.Btree.Impl.Singlevalue.BTreeSingleValuePerKey
	{
		public ODBBTreeSingle() : base()
		{
		}
		...
		{
			return new NeoDatis.Odb.Impl.Core.Btree.ODBBTreeNodeSingle(this);
		}
