...
{
	public class AtomicNativeObjectSerializer : NeoDatis.Odb.Impl.Core.Layers.Layer2.Meta.Serialization.ISerializer
	{
		public static readonly string classId = NeoDatis.Odb.Impl.Core.Layers.Layer2.Meta.Serialization.Serializer
			.GetClassId(typeof(NeoDatis.Odb.Core.Layers.Layer2.Meta.AtomicNativeObjectInfo));
